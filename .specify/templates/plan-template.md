...
- **Security / fail-closed / rate limiting**: Explain authentication or public contract, input validation, secret handling, structured logging without sensitive data, external failure handling, and rate limiting for public endpoints. If not applicable, state why.
