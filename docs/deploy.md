...
PRICE_MONITOR_AFFILIATE_FEED_REFRESH_INTERVAL_SECONDS=21600
PRICE_MONITOR_DECODO_SCRAPER_API_URL=https://scraper-api.decodo.com/v2/scrape
PRICE_MONITOR_DECODO_BASIC_AUTH_TOKEN=<server-managed-decodo-basic-token>
PRICE_MONITOR_DECODO_DEFAULT_HEADLESS=html
PRICE_MONITOR_DECODO_DEFAULT_PROXY_POOL=premium
PRICE_MONITOR_DECODO_DEFAULT_DEVICE_TYPE=desktop
PRICE_MONITOR_DECODO_REQUEST_TIMEOUT_SECONDS=150
```
